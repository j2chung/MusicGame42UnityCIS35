...
public class NewBehaviourScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        MidiFile midiFile = MidiFile.Read(path + "/hal6.mid");
    ...
    void Update()
    {
        ...
        if (songposition >= 157)
        {
            PlayerPrefs.SetInt("Current Score", GameManager.instance.score);
            PlayerPrefs.SetInt("Max Combo", GameManager.instance.maxCombo);
            PlayerPrefs.SetInt("Notes Hit", GameManager.instance.notesHit);
            if (PlayerPrefs.GetInt("High Score") < GameManager.instance.score)
            {
